...
import * as import8 from 'angular2-grid/modules/NgGrid.module';
import * as import9 from '../../../src/app/home/home.module';
...
import * as import33 from '../../../src/app/dynamicloaderservice';
import * as import34 from '@angular/core/src/di/injector';
import * as import35 from '../../node_modules/angular2-grid/components/NgGridPlaceholder.ngfactory';
...
import * as import39 from '@angular/compiler/src/jit/compiler';
...
import * as import47 from '../../../src/app/home/home.component';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _NgGridModule_6:import8.NgGridModule;
  _HomeModule_7:import9.HomeModule;
  _ROUTER_FORROOT_GUARD_8:any;
  _RouterModule_9:import10.RouterModule;
  ...
  __BrowserXhr_38:import24.BrowserXhr;
  __ResponseOptions_39:import25.BaseResponseOptions;
  __XSRFStrategy_40:any;
  __XHRBackend_41:import26.XHRBackend;
  __RequestOptions_42:import27.BaseRequestOptions;
  __Http_43:any;
  __ROUTER_CONFIGURATION_44:any;
  __LocationStrategy_45:any;
  __Location_46:import28.Location;
  __UrlSerializer_47:import29.DefaultUrlSerializer;
  __RouterOutletMap_48:import30.RouterOutletMap;
  __NgModuleFactoryLoader_49:import31.SystemJsNgModuleLoader;
  __ROUTES_50:any[];
  __Router_51:any;
  __ActivatedRoute_52:any;
  _NoPreloading_53:import32.NoPreloading;
  _PreloadingStrategy_54:any;
  _RouterPreloader_55:import32.RouterPreloader;
  __PreloadAllModules_56:import32.PreloadAllModules;
  __ROUTER_INITIALIZER_57:any;
  __APP_BOOTSTRAP_LISTENER_58:any[];
  __DynamicLoaderService_59:import33.DynamicLoaderService;
  constructor(parent:import34.Injector) {
    super(parent,[
      import35.NgGridPlaceholderNgFactory,
  ...
  get _LOCALE_ID_11():any {
    if ((this.__LOCALE_ID_11 == null)) { (this.__LOCALE_ID_11 = import3._localeFactory(this.parent.get(import38.LOCALE_ID,(null as any)))); }
  ...
  get _Compiler_18():any {
    if ((this.__Compiler_18 == null)) { (this.__Compiler_18 = this.parent.get(import39.JitCompiler)); }
  ...
  get _EventManager_23():import16.EventManager {
    if ((this.__EventManager_23 == null)) { (this.__EventManager_23 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_22,this.parent.get(import43.NgZone))); }
  ...
  get _NgProbeToken_27():any[] {
    if ((this.__NgProbeToken_27 == null)) { (this.__NgProbeToken_27 = [import10.routerNgProbeToken()]); }
  ...
  get _AnimationQueue_31():import20.AnimationQueue {
    if ((this.__AnimationQueue_31 == null)) { (this.__AnimationQueue_31 = new import20.AnimationQueue(this.parent.get(import43.NgZone))); }
  ...
  get _BrowserXhr_38():import24.BrowserXhr {
    if ((this.__BrowserXhr_38 == null)) { (this.__BrowserXhr_38 = new import24.BrowserXhr()); }
    return this.__BrowserXhr_38;
  }
  get _ResponseOptions_39():import25.BaseResponseOptions {
    if ((this.__ResponseOptions_39 == null)) { (this.__ResponseOptions_39 = new import25.BaseResponseOptions()); }
  ...
  get _XHRBackend_41():import26.XHRBackend {
    if ((this.__XHRBackend_41 == null)) { (this.__XHRBackend_41 = new import26.XHRBackend(this._BrowserXhr_38,this._ResponseOptions_39,this._XSRFStrategy_40)); }
    return this.__XHRBackend_41;
  }
  get _RequestOptions_42():import27.BaseRequestOptions {
    if ((this.__RequestOptions_42 == null)) { (this.__RequestOptions_42 = new import27.BaseRequestOptions()); }
  ...
  get _LocationStrategy_45():any {
    if ((this.__LocationStrategy_45 == null)) { (this.__LocationStrategy_45 = import10.provideLocationStrategy(this.parent.get(import45.PlatformLocation),this.parent.get(import46.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_44)); }
    return this.__LocationStrategy_45;
  }
  get _Location_46():import28.Location {
    if ((this.__Location_46 == null)) { (this.__Location_46 = new import28.Location(this._LocationStrategy_45)); }
    return this.__Location_46;
  }
  get _UrlSerializer_47():import29.DefaultUrlSerializer {
    if ((this.__UrlSerializer_47 == null)) { (this.__UrlSerializer_47 = new import29.DefaultUrlSerializer()); }
    return this.__UrlSerializer_47;
  }
  get _RouterOutletMap_48():import30.RouterOutletMap {
    if ((this.__RouterOutletMap_48 == null)) { (this.__RouterOutletMap_48 = new import30.RouterOutletMap()); }
    return this.__RouterOutletMap_48;
  }
  get _NgModuleFactoryLoader_49():import31.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_49 == null)) { (this.__NgModuleFactoryLoader_49 = new import31.SystemJsNgModuleLoader(this._Compiler_18,this.parent.get(import31.SystemJsNgModuleLoaderConfig,(null as any)))); }
  ...
  get _Router_51():any {
    if ((this.__Router_51 == null)) { (this.__Router_51 = import10.setupRouter(this._ApplicationRef_17,this._UrlSerializer_47,this._RouterOutletMap_48,this._Location_46,this,this._NgModuleFactoryLoader_49,this._Compiler_18,this._ROUTES_50,this._ROUTER_CONFIGURATION_44,this.parent.get(import48.UrlHandlingStrategy,(null as any)),this.parent.get(import49.RouteReuseStrategy,(null as any)))); }
    return this.__Router_51;
  }
  get _ActivatedRoute_52():any {
    if ((this.__ActivatedRoute_52 == null)) { (this.__ActivatedRoute_52 = import10.rootRoute(this._Router_51)); }
    return this.__ActivatedRoute_52;
  }
  get _PreloadAllModules_56():import32.PreloadAllModules {
    if ((this.__PreloadAllModules_56 == null)) { (this.__PreloadAllModules_56 = new import32.PreloadAllModules()); }
    return this.__PreloadAllModules_56;
  }
  get _ROUTER_INITIALIZER_57():any {
    if ((this.__ROUTER_INITIALIZER_57 == null)) { (this.__ROUTER_INITIALIZER_57 = import10.initialRouterNavigation(this._Router_51,this._ApplicationRef_17,this._RouterPreloader_55,this._ROUTER_CONFIGURATION_44)); }
  ...
  get _DynamicLoaderService_59():import33.DynamicLoaderService {
    if ((this.__DynamicLoaderService_59 == null)) { (this.__DynamicLoaderService_59 = new import33.DynamicLoaderService(this._Compiler_18)); }
    return this.__DynamicLoaderService_59;
  }
  createInternal():import1.AppModule {
    ...
    this._NgGridModule_6 = new import8.NgGridModule();
    this._HomeModule_7 = new import9.HomeModule();
    this._ROUTER_FORROOT_GUARD_8 = import10.provideForRootGuard(this.parent.get(import50.Router,(null as any)));
    this._RouterModule_9 = new import10.RouterModule(this._ROUTER_FORROOT_GUARD_8);
    ...
    this._ApplicationRef__16 = new import14.ApplicationRef_(this.parent.get(import43.NgZone),this.parent.get(import51.Console),this,this._ErrorHandler_13,this,this._ApplicationInitStatus_14,this.parent.get(import13.TestabilityRegistry,(null as any)),this._Testability_15);
    this._DomSharedStylesHost_24 = new import17.DomSharedStylesHost(this._DOCUMENT_20);
    this._NoPreloading_53 = new import32.NoPreloading();
    this._PreloadingStrategy_54 = this._NoPreloading_53;
    this._RouterPreloader_55 = new import32.RouterPreloader(this._Router_51,this._NgModuleFactoryLoader_49,this._Compiler_18,this,this._PreloadingStrategy_54);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import8.NgGridModule)) { return this._NgGridModule_6; }
    if ((token === import9.HomeModule)) { return this._HomeModule_7; }
    if ((token === import10.ROUTER_FORROOT_GUARD)) { return this._ROUTER_FORROOT_GUARD_8; }
    if ((token === import10.RouterModule)) { return this._RouterModule_9; }
    if ((token === import1.AppModule)) { return this._AppModule_10; }
    if ((token === import38.LOCALE_ID)) { return this._LOCALE_ID_11; }
    if ((token === import11.NgLocalization)) { return this._NgLocalization_12; }
    if ((token === import52.ErrorHandler)) { return this._ErrorHandler_13; }
    ...
    if ((token === import53.Compiler)) { return this._Compiler_18; }
    if ((token === import40.APP_ID)) { return this._APP_ID_19; }
    if ((token === import54.DOCUMENT)) { return this._DOCUMENT_20; }
    ...
    if ((token === import55.AnimationDriver)) { return this._AnimationDriver_25; }
    ...
    if ((token === import56.RootRenderer)) { return this._RootRenderer_28; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_29; }
    if ((token === import57.Sanitizer)) { return this._Sanitizer_30; }
    if ((token === import20.AnimationQueue)) { return this._AnimationQueue_31; }
    if ((token === import21.ViewUtils)) { return this._ViewUtils_32; }
    if ((token === import58.IterableDiffers)) { return this._IterableDiffers_33; }
    if ((token === import59.KeyValueDiffers)) { return this._KeyValueDiffers_34; }
    ...
    if ((token === import24.BrowserXhr)) { return this._BrowserXhr_38; }
    if ((token === import25.ResponseOptions)) { return this._ResponseOptions_39; }
    if ((token === import60.XSRFStrategy)) { return this._XSRFStrategy_40; }
    if ((token === import26.XHRBackend)) { return this._XHRBackend_41; }
    if ((token === import27.RequestOptions)) { return this._RequestOptions_42; }
    if ((token === import61.Http)) { return this._Http_43; }
    if ((token === import10.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_44; }
    if ((token === import46.LocationStrategy)) { return this._LocationStrategy_45; }
    if ((token === import28.Location)) { return this._Location_46; }
    if ((token === import29.UrlSerializer)) { return this._UrlSerializer_47; }
    if ((token === import30.RouterOutletMap)) { return this._RouterOutletMap_48; }
    if ((token === import62.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_49; }
    if ((token === import63.ROUTES)) { return this._ROUTES_50; }
    if ((token === import50.Router)) { return this._Router_51; }
    if ((token === import64.ActivatedRoute)) { return this._ActivatedRoute_52; }
    if ((token === import32.NoPreloading)) { return this._NoPreloading_53; }
    if ((token === import32.PreloadingStrategy)) { return this._PreloadingStrategy_54; }
    if ((token === import32.RouterPreloader)) { return this._RouterPreloader_55; }
    if ((token === import32.PreloadAllModules)) { return this._PreloadAllModules_56; }
    if ((token === import10.ROUTER_INITIALIZER)) { return this._ROUTER_INITIALIZER_57; }
    if ((token === import40.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_58; }
    if ((token === import33.DynamicLoaderService)) { return this._DynamicLoaderService_59; }
